...
export class SmartTableComponent implements OnInit, OnChanges {
  ...
  @Input() labelTotalRecords: string = 'general.totalRecords';
  @Input() labelNoRecords: string = 'general.noRecords';
  ...
  onSelectAllRows($event: any) {
    ...
    this.grid.checkSelectAllRows(this.isAllSelected);
  ...
  prepareSource(): DataSource {
    if (this.source instanceof DataSource) {
      ...
      let localDataSource = new LocalDataSource(this.source);
      this.sortColumnId = this.sortColumnId === "" ? Object.keys(this.source)[0] : this.sortColumnId;
