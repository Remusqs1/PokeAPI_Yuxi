import {
  ...
  HostListener, Inject, KeyValueDiffer, KeyValueDiffers, Input, OnInit, Optional
} from '@angular/core';
import { AbstractControl, ControlValueAccessor, NG_VALIDATORS, NG_VALUE_ACCESSOR, Validator } from '@angular/forms';

import { CurrencyMaskConfig, CURRENCY_MASK_CONFIG } from '../Classes/currency-mask.config';
...
export class CurrencyMaskDirective implements AfterViewInit, ControlValueAccessor, DoCheck, OnInit, Validator {
    ...
    constructor(@Optional() @Inject(CURRENCY_MASK_CONFIG)
      private currencyMaskConfig: CurrencyMaskConfig, private elementRef: ElementRef, private keyValueDiffers: KeyValueDiffers) {
    ...
    handleBlur(event: any) {
        console.log('mask blur event', event);
