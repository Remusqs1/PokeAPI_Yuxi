...
@Injectable()
export class AgreementFormsService {

    constructor(private formBuilder: FormBuilder, private statusPipe: StatusPipe) { }

    getFilterForm(): FormGroup {
        return this.formBuilder.group({
            agreementName: [{ value: undefined, disabled: false }, []],
            agreementState: [{ value: undefined, disabled: false }, []],
        });
    }
    ...
    getConfigDataTable() {
        ...
        const columns: any = {
            agr_name: {
                title: 'agreement.grid.columnsName.name',
                filter: false,
            },
            agr_status: {
                title: 'agreement.grid.columnsName.state',
                filter: false,
