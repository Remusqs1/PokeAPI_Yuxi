...
import { CertificadoaldiaService } from '../Services/certificadoaldia.service';
import { GetUserProductsIn } from '../MethodParameters/GetUserProductsIn';
import { CertificadoaldiaFormService } from '../Services/certificadoaldia.form.service';
import { StatusPipe } from '../../../../Shared/Pipes/statusPipe';
import { GetFilePeaceSafeIn } from '../MethodParameters/GetFilePeaceSafeIn';

@Component({
  selector: 'app-movements',
  templateUrl: './certificadoaldia.component.html',
  styleUrls: ['./certificadoaldia.component.css']
})
export class CertificadoaldiaComponent implements OnInit {
  ...
  constructor(private formService: CertificadoaldiaFormService,
    private service: CertificadoaldiaService,
