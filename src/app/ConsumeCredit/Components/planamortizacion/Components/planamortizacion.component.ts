...
import { PlanamortizacionService } from '../Services/planamortizacion.service';
import { GetUserProductsIn } from '../MethodParameters/GetUserProductsIn';
import { PlanamortizacionFormService } from '../Services/planamortizacion.form.service';
import { StatusPipe } from '../../../../Shared/Pipes/statusPipe';
import { GetFilePeaceSafeIn } from '../MethodParameters/GetFilePeaceSafeIn';

@Component({
  selector: 'app-movements',
  templateUrl: './planamortizacion.component.html',
  styleUrls: ['./planamortizacion.component.css']
})
export class PlanamortizacionComponent implements OnInit {
  ...
  constructor(private formService: PlanamortizacionFormService,
    private service: PlanamortizacionService,
