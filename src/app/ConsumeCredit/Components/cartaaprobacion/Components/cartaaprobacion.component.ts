...
import { CartaaprobacionService } from '../Services/cartaaprobacion.service';
import { GetUserProductsIn } from '../MethodParameters/GetUserProductsIn';
import { CartaaprobacionFormService } from '../Services/cartaaprobacion.form.service';
import { StatusPipe } from '../../../../Shared/Pipes/statusPipe';
import { GetFilePeaceSafeIn } from '../MethodParameters/GetFilePeaceSafeIn';

@Component({
  selector: 'app-movements',
  templateUrl: './cartaaprobacion.component.html',
  styleUrls: ['./cartaaprobacion.component.css']
})
export class CartaaprobacionComponent implements OnInit {
  ...
  constructor(private formService: CartaaprobacionFormService,
    private service: CartaaprobacionService,
