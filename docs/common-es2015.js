...
/* harmony import */ var _Services_common_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../Services/common.service */ "./src/app/Commons/Services/common.service.ts");
...
let NavBarComponent = class NavBarComponent {
    ...
    onSearch() {
        let searchValue = this.searchForm.get('searchPokemon').value.toLowerCase();
        ;
...
NavBarComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-navbar',
        template: __importDefault(__webpack_require__(/*! raw-loader!./navbar.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/Commons/Components/NavBar/navbar.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./navbar.component.css */ "./src/app/Commons/Components/NavBar/navbar.component.css")).default]
    }),
    __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _Services_common_service__WEBPACK_IMPORTED_MODULE_2__["CommonService"]])
], NavBarComponent);
...
/* harmony import */ var _commons_routing__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./commons.routing */ "./src/app/Commons/commons.routing.ts");
/* harmony import */ var _Components_NavBar_navbar_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Components/NavBar/navbar.component */ "./src/app/Commons/Components/NavBar/navbar.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
CommonsModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        imports: [
            ...
            _commons_routing__WEBPACK_IMPORTED_MODULE_5__["COMMONS_ROUTES"]
        ],
        declarations: [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "COMMONS_ROUTES", function() { return COMMONS_ROUTES; });
...
const SharedRoutes = [];
const COMMONS_ROUTES = _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(SharedRoutes);
...
let PokeService = class PokeService {
    ...
    getPokes(index) {
        return this.http.get(`${this.pokeUrl}/pokemon/${index}`);
    }
    getPoke() {
