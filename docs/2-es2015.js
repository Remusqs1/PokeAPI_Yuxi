...
/* harmony import */ var _MethodParameters_pokemon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../MethodParameters/pokemon */ "./src/app/Management/MethodParameters/pokemon.ts");
/* harmony import */ var _Home_Services_pokeService_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../Home/Services/pokeService.service */ "./src/app/Management/Components/Home/Services/pokeService.service.ts");
...
let DetailsComponent = class DetailsComponent {
    constructor(activatedRoute, pokeService, routes, toastr) {
    ...
    getPokemon(input) {
        this.pokeService.getPokes(input).subscribe(res => {
            console.log(res);
            this.pokemon = new _MethodParameters_pokemon__WEBPACK_IMPORTED_MODULE_2__["Pokemon"]();
            ...
            this.pokemon.movList = new Array();
...
DetailsComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./details.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/Management/Components/Details/Components/details.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./details.component.css */ "./src/app/Management/Components/Details/Components/details.component.css")).default]
    }),
    __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _Home_Services_pokeService_service__WEBPACK_IMPORTED_MODULE_3__["PokeService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"]])
], DetailsComponent);
...
/* harmony import */ var _Home_Services_pokeService_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Home/Services/pokeService.service */ "./src/app/Management/Components/Home/Services/pokeService.service.ts");
/* harmony import */ var _Components_details_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Components/details.component */ "./src/app/Management/Components/Details/Components/details.component.ts");
/* harmony import */ var _details_routing__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./details.routing */ "./src/app/Management/Components/Details/details.routing.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
DetailsModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        imports: [
            ...
            _details_routing__WEBPACK_IMPORTED_MODULE_7__["DETAILS_ROUTES"],
        ...
        declarations: [
            _Components_details_component__WEBPACK_IMPORTED_MODULE_6__["DetailsComponent"]
        ],
        exports: [
            _Components_details_component__WEBPACK_IMPORTED_MODULE_6__["DetailsComponent"]
        ],
        providers: [
            _Home_Services_pokeService_service__WEBPACK_IMPORTED_MODULE_5__["PokeService"],
        ]
    })
], DetailsModule);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DETAILS_ROUTES", function() { return DETAILS_ROUTES; });
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _Components_details_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Components/details.component */ "./src/app/Management/Components/Details/Components/details.component.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
const DETAILS_ROUTES = _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(DetailsRoutes);
