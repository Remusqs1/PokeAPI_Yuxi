...
/* harmony import */ var _Services_authentication_form_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../Services/authentication.form.service */ "./src/app/Administration/Components/Authentication/Services/authentication.form.service.ts");
/* harmony import */ var _Commons_Entities_user__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../Commons/Entities/user */ "./src/app/Commons/Entities/user.ts");
...
let LoginComponent = class LoginComponent {
    constructor(authenticationFormService, routes) {
    ...
    onLoggedIn() {
        ...
        if (this.loginForm.valid) {
            //LocalStorage
            let user = new _Commons_Entities_user__WEBPACK_IMPORTED_MODULE_3__["User"]();
...
LoginComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-login',
        template: __importDefault(__webpack_require__(/*! raw-loader!./login.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/Administration/Components/Authentication/Components/Login/login.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./login.component.css */ "./src/app/Administration/Components/Authentication/Components/Login/login.component.css")).default]
    }),
    __metadata("design:paramtypes", [_Services_authentication_form_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationFormService"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _Commons_Entities_user__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../Commons/Entities/user */ "./src/app/Commons/Entities/user.ts");
/* harmony import */ var _Services_authentication_form_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../Services/authentication.form.service */ "./src/app/Administration/Components/Authentication/Services/authentication.form.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let RegisterComponent = class RegisterComponent {
    ...
    register() {
        ...
        if (this.registerForm.valid) {
            //LocalStorage
            let user = new _Commons_Entities_user__WEBPACK_IMPORTED_MODULE_2__["User"]();
...
RegisterComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./register.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/Administration/Components/Authentication/Components/Register/register.component.html")).default
    }),
    __metadata("design:paramtypes", [_Services_authentication_form_service__WEBPACK_IMPORTED_MODULE_3__["AuthenticationFormService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])
], RegisterComponent);
...
/* harmony import */ var _Commons_Classes_customValidators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../Commons/Classes/customValidators */ "./src/app/Commons/Classes/customValidators.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let AuthenticationFormService = class AuthenticationFormService {
    constructor(formBuilder) {
        this.formBuilder = formBuilder;
    }
    getLoginForm() {
        return this.formBuilder.group({
            email: [{ value: undefined, disabled: false }, [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].nullValidator, _Commons_Classes_customValidators__WEBPACK_IMPORTED_MODULE_2__["CustomValidators"].IsNullorEmpty, _Commons_Classes_customValidators__WEBPACK_IMPORTED_MODULE_2__["CustomValidators"].EmailFormat]],
            psw: [{ value: undefined, disabled: false }, [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].nullValidator, _Commons_Classes_customValidators__WEBPACK_IMPORTED_MODULE_2__["CustomValidators"].IsNullorEmpty]]
        });
    }
    getRegisterForm() {
        return this.formBuilder.group({
            name: [{ value: undefined, disabled: false }, [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].nullValidator, _Commons_Classes_customValidators__WEBPACK_IMPORTED_MODULE_2__["CustomValidators"].IsNullorEmpty]],
            email: [{ value: undefined, disabled: false }, [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].nullValidator, _Commons_Classes_customValidators__WEBPACK_IMPORTED_MODULE_2__["CustomValidators"].IsNullorEmpty, _Commons_Classes_customValidators__WEBPACK_IMPORTED_MODULE_2__["CustomValidators"].EmailFormat]],
            psw: [{ value: undefined, disabled: false }, [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].nullValidator, _Commons_Classes_customValidators__WEBPACK_IMPORTED_MODULE_2__["CustomValidators"].IsNullorEmpty]],
            confirmPsw: [{ value: undefined, disabled: false }, [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].nullValidator, _Commons_Classes_customValidators__WEBPACK_IMPORTED_MODULE_2__["CustomValidators"].IsNullorEmpty]]
        });
    }
};
AuthenticationFormService.ctorParameters = () => [
...
/* harmony import */ var _Components_Login_login_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Login/login.component */ "./src/app/Administration/Components/Authentication/Components/Login/login.component.ts");
/* harmony import */ var _authentication_routing__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./authentication.routing */ "./src/app/Administration/Components/Authentication/authentication.routing.ts");
/* harmony import */ var _Services_authentication_form_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Services/authentication.form.service */ "./src/app/Administration/Components/Authentication/Services/authentication.form.service.ts");
/* harmony import */ var _Components_Register_register_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Components/Register/register.component */ "./src/app/Administration/Components/Authentication/Components/Register/register.component.ts");
/* harmony import */ var _Shared_shared_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../Shared/shared.module */ "./src/app/Shared/shared.module.ts");
/* harmony import */ var _Commons_Services_common_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../Commons/Services/common.service */ "./src/app/Commons/Services/common.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AuthenticationModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        imports: [
            ...
            _authentication_routing__WEBPACK_IMPORTED_MODULE_4__["AUTHENTICATION_ROUTES"],
        ...
        providers: [
            _Services_authentication_form_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticationFormService"],
            _Commons_Services_common_service__WEBPACK_IMPORTED_MODULE_8__["CommonService"]
        ]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AUTHENTICATION_ROUTES", function() { return AUTHENTICATION_ROUTES; });
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _Components_Login_login_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Components/Login/login.component */ "./src/app/Administration/Components/Authentication/Components/Login/login.component.ts");
/* harmony import */ var _Components_Register_register_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Components/Register/register.component */ "./src/app/Administration/Components/Authentication/Components/Register/register.component.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
const AUTHENTICATION_ROUTES = _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(AuthenticationRoutes);
